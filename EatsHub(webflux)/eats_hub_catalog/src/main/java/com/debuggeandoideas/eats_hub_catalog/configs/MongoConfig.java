...
@Configuration
@EnableReactiveMongoRepositories("com.debuggeandoideas.eats_hub_catalog")
...
public class MongoConfig extends AbstractReactiveMongoConfiguration {
    ...
    @Value("${mongodb.max.PoolSize}")
    private Integer maxPoolSize;

    @Value("${mongodb.min.PoolSize}")
    ...
    public MongoClient reactiveMongoClient() {
        final ConnectionString connection = new ConnectionString(String.format("mongodb://%s:%d/%s", host, port, database));
